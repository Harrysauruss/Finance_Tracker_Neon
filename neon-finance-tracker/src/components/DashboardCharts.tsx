...
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, PieChart, Pie, Label, Cell, ResponsiveContainer } from "recharts"
...
export function DashboardCharts({
  ...
  const [selectedMonth, setSelectedMonth] = useState<string>(monthlyData[0]?.month || "")
        ...
        <CardContent className="h-[400px] pt-4">
          <ChartContainer config={chartConfig} className="w-full h-full">
            <BarChart data={chartData}>
              ...
              <Bar dataKey="income" fill="#22c55e" stroke="" radius={[4, 4, 0, 0]} />
              <Bar dataKey="expenses" fill="#ef4444" stroke="" radius={[4, 4, 0, 0]} />
            </BarChart>
          </ChartContainer>
        </CardContent>
      </Card>

      <div className={`grid gap-4 ${isDropdownOpen ? "md:grid-cols-1" : "md:grid-cols-2"}`}>
